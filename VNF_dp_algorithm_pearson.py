...
class VNF_aggregation(object):
    ...
    def map_req2host(self, route, core_link, e_link, request_lib, host_lib):     #map the request to host
        ...
        print "req_abandoned vnf_chain:", req_abandoned
        return host_id
...
def VNF_simulation_pearson(data_back):
    ...
    with open('F:/VNF_Review/ldf/simulation/data_store/host_lib_pearson.pickle', 'w') as f:
    ...
    with open('F:/VNF_Review/ldf/simulation/data_store/saved_info_dict_pearson.json', 'w') as f:
