...
class VNF_aggregation(object):
    def calc_d_val_square(self, mtr1,mtr2):              #calc square value
        #print "*****calc d value*****"
        [row,col] = mtr1.shape
        #mtr_temp = np.zeros([row,col])
        #normalization
...
def VNF_simulation_square(data_back):
    ...
    with open('F:/VNF_Review/ldf/simulation/data_store/host_lib_square.pickle', 'w') as f:
    ...
    with open('F:/VNF_Review/ldf/simulation/data_store/saved_info_dict_square.json', 'w') as f:
