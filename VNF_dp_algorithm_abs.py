...
def VNF_simulation_abs(data_back):
    ...
    with open('F:/VNF_Review/ldf/simulation/data_store/host_lib_abs.pickle', 'w') as f:
    ...
    with open('F:/VNF_Review/ldf/simulation/data_store/saved_info_dict_abs.json', 'w') as f:
