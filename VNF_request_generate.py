...
if __name__ == '__main__':
    for i in range(10):
        ...
        #with open('/home/infonet/VNF_deploy_time_varying/data_store/data_new500.pickle', 'r') as f:
            #data_back = pickle.load(f)
        with open('F:/VNF_Review/ldf\simulation\data/'+'data_'+str(REQUEST_NUM)+'_'+str(i)+'.pickle', 'w') as f:
            pickle.dump(data,f)
        with open('F:/VNF_Review/ldf\simulation\data/'+'data_'+str(REQUEST_NUM)+'_'+str(i)+'.pickle', 'r') as f:
            data_back = pickle.load(f)
