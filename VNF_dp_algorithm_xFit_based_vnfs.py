...
class VNF_xFit(object):
    ...
    def FF_map(self, route, core_link, e_link, NFR_lib, host_lib, NFR_id_list):      #map the request to host using First Fit
        ...
        for i in NFR_id_list:
            ...
            for j in range(len(host_list)):
                ...
                if self.check_end(path, core_link, NFR_lib[i], host_lib[host_list[j].id]) == 1:
                    if NFR_lib[i][0] in host_lib[host_list[j].id].req_container:
                        ...
                        self.verify_node_resource_left(path, core_link, NFR_lib[i],host_lib[host_list[j].id])
                        self.verify_band_left_1(path,core_link,NFR_lib[i],host_lib[host_list[j].id])
                    else:
                        ...
                        self.verify_node_resource_left(path, core_link, NFR_lib[i],host_lib[host_list[j].id])
                        self.verify_band_left_0(path,core_link,NFR_lib[i],host_lib[host_list[j].id])
    ...
    def FFD_map(self, route, core_link, e_link, request_lib, host_lib):
        ...
        VNF_resort_list = []
        for i in range(len(req_id_list)):
            NFR_id = req_id_list[i]
            tuple_vnf = (request_lib[NFR_id][0],request_lib[NFR_id][1].id)
            VNF_resort_list.append(tuple_vnf)
        print "VNF_resort list :",VNF_resort_list
...
def VNF_simulation_xFit_randomized_w(data_back):
    ...
    with open('F:/VNF_Review/ldf/simulation/data_store/saved_info_dict_NF_rw.json', 'w') as f:
    ...
    #with open('F:/VNF_Review/ldf/simulation/data_store/host_lib_FF_rw.pickle', 'w') as f:
        #pickle.dump(host_lib_ff,f)
    saved_info_dict_ff = {}
    saved_info_dict_ff[0] = host_id_ff+1
    print "the used host num(ff) is:",host_id_ff+1
    with open('F:/VNF_Review/ldf/simulation/data_store/saved_info_dict_FF_rw.json', 'w') as f:
    ...
    #with open('F:/VNF_Review/ldf/simulation/data_store/host_lib_FFD_rw.pickle', 'w') as f:
        #pickle.dump(host_lib_ffd,f)
    saved_info_dict_ffd = {}
    saved_info_dict_ffd[0] = host_id_ffd+1
    with open('F:/VNF_Review/ldf/simulation/data_store/saved_info_dict_FFD_rw.json', 'w') as f:
    ...
    #with open('F:/VNF_Review/ldf/simulation/data_store/host_lib_BF_rw.pickle', 'w') as f:
        #pickle.dump(host_lib_bf,f)
    saved_info_dict_bf = {}
    saved_info_dict_bf[0] = host_id_bf+1
    with open('F:/VNF_Review/ldf/simulation/data_store/saved_info_dict_BF_rw.json', 'w') as f:
    ...
    #with open('F:/VNF_Review/ldf/simulation/data_store/host_lib_BFD_rw.pickle', 'w') as f:
        #pickle.dump(host_lib_bfd,f)
    saved_info_dict_bfd = {}
    saved_info_dict_bfd[0] = host_id_bfd+1
    with open('F:/VNF_Review/ldf/simulation/data_store/saved_info_dict_BFD_rw.json', 'w') as f:
...
def VNF_simulation_xFit_non_randomized_w(data_back):
    ...
    with open('F:/VNF_Review/ldf/simulation/data_store/host_lib_NF_nrw.pickle', 'w') as f:
        pickle.dump(host_lib_nf,f)
    saved_info_dict_nf = {}
    saved_info_dict_nf[0] = host_id_nf+1
    print "the used host num(nf) is:",host_id_nf+1
    with open('F:/VNF_Review/ldf/simulation/data_store/saved_info_dict_NF_nrw.json', 'w') as f:
        json.dump(saved_info_dict_nf,f)
    
    host_id_ff = host_info_ff[0]
    host_lib_ff = host_info_ff[1]
    
    with open('F:/VNF_Review/ldf/simulation/data_store/host_lib_FF_nrw.pickle', 'w') as f:
        pickle.dump(host_lib_ff,f)
    saved_info_dict_ff = {}
    saved_info_dict_ff[0] = host_id_ff+1
    print "the used host num(ff) is:",host_id_ff+1
    with open('F:/VNF_Review/ldf/simulation/data_store/saved_info_dict_FF_nrw.json', 'w') as f:
        json.dump(saved_info_dict_ff,f)
    
    host_id_ffd = host_info_ffd[0]
    host_lib_ffd = host_info_ffd[1]
    print "the used host num(ffd) is:",host_id_ffd+1
    with open('F:/VNF_Review/ldf/simulation/data_store/host_lib_FFD_nrw.pickle', 'w') as f:
        pickle.dump(host_lib_ffd,f)
    saved_info_dict_ffd = {}
    saved_info_dict_ffd[0] = host_id_ffd+1
    with open('F:/VNF_Review/ldf/simulation/data_store/saved_info_dict_FFD_nrw.json', 'w') as f:
        json.dump(saved_info_dict_ffd,f)
    ...
    with open('F:/VNF_Review/ldf/simulation/data_store/host_lib_BF_nrw.pickle', 'w') as f:
        pickle.dump(host_lib_bf,f)
    saved_info_dict_bf = {}
    saved_info_dict_bf[0] = host_id_bf+1
    with open('F:/VNF_Review/ldf/simulation/data_store/saved_info_dict_BF_nrw.json', 'w') as f:
        json.dump(saved_info_dict_bf,f)
    ...
    with open('F:/VNF_Review/ldf/simulation/data_store/host_lib_BFD_nrw.pickle', 'w') as f:
        pickle.dump(host_lib_bfd,f)
    saved_info_dict_bfd = {}
    saved_info_dict_bfd[0] = host_id_bfd+1
    with open('F:/VNF_Review/ldf/simulation/data_store/saved_info_dict_BFD_nrw.json', 'w') as f:
        json.dump(saved_info_dict_bfd,f)
    #saved_host_bfd = []
    #host_resource_left_check(host_lib_bfd,host_id_bfd,saved_host_bfd)
