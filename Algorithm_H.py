...
def Algorithm_H_r(data_back):
    ...
    with open('F:/VNF_Review/ldf/simulation/data_store/host_lib_AH_r.pickle', 'w') as f:
        pickle.dump(host_lib_AH,f)
    saved_info_dict_AH = {}
    saved_info_dict_AH[0] = host_id_AH+1
    with open('F:/VNF_Review/ldf/simulation/data_store/saved_info_dict_AH_r.json', 'w') as f:
...
def Algorithm_H_nr(data_back):
    ...
    with open('F:/VNF_Review/ldf/simulation/data_store/host_lib_AH_nr.pickle', 'w') as f:
        pickle.dump(host_lib_AH,f)
    saved_info_dict_AH = {}
    saved_info_dict_AH[0] = host_id_AH+1
    with open('F:/VNF_Review/ldf/simulation/data_store/saved_info_dict_AH_nr.json', 'w') as f:
        json.dump(saved_info_dict_AH,f)
